...
*/
void bmp180::write8(uint8_t add, uint8_t data){
...
*/
uint16_t bmp180::read16(uint8_t add){
  uint16_t temp;
  Wire.beginTransmission(bmp_add);
  Wire.write(add);
  Wire.endTransmission();
...
*/
uint8_t bmp180::read8(uint8_t add){
  uint16_t temp;
  Wire.beginTransmission(bmp_add);
  Wire.write(add);
  Wire.endTransmission();
